...
const DocumentUploadField = ({
  ...
  const hasError = errors[req.key] !== undefined; // 2. Verificamos si hay un archivo existente O un archivo nuevo seleccionado
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center flex-grow">
          ...
          <FontAwesomeIcon
            ...
            className={`mr-3 ${
              isFilePresent ? "text-green-500" : "text-blue-500"
            }`}
          />
                   {" "}
          ...
          <span
            className={`text-sm flex-grow ${
              isFilePresent ? "text-gray-600" : "text-black"
            }`}
    ...
    {tipoPersona && (
      <>
        ...
        <input
          ...
          {...register("dni", {
            required: `${
              tipoPersona === "Jurídica" ? "El CUIT" : "El DNI"
            } es requerido`,
          })}
          className="w-full bg-gray-100 text-black px-4 py-2 rounded-md my-2"
          placeholder={
