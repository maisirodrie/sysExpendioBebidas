...
      // Se utiliza updateTask para cambiar el estado de pago (pago: boolean)
...
    // Se confirma que 'editor' tiene permiso para cambiar el estado
...
  // Opciones de cambio de estado permitidas por cada rol
  const statusOptions = {
    mesa: {
...
    },
    editor: {
      // El editor tiene las mismas opciones amplias que el admin para el cambio de estado
...
        // Si el estado es "rechazado" y el usuario es juridicos, admin, o editor, solicitar el motivo
...
            }
        } else {
            // Usar updateTaskStatus para cambios de estado normales
...
                  </Link>
               )}
                {/* Botón para generar el reporte PDF (Desactivado por defecto) */}
...
                            </span>
                          )}
                          {/* Botón para editar el motivo de rechazo */}
