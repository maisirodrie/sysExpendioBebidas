...
export const PublicLayout = ({
  ...
  return (
    ...
    >
      ...
      {/* BANNER AVISO DE MANTENIMIENTO */}
      <div className="relative z-40 w-full bg-amber-500 text-slate-950 px-4 py-2 text-center text-xs sm:text-sm font-semibold flex items-center justify-center gap-2 shadow-sm">
        ...
        <span>
          Aviso institucional: El sistema se encuentra en mantenimiento programado. Los servicios se reanudarán a la brevedad.
        </span>
      </div>
